...
SELECT * FROM Pessoas ORDER BY data_nasc DESC;
...
SELECT * FROM Pessoas WHERE nome LIKE '%R%';
...
--Escreva um comando select que retorne as seguintes colunas: nome, data_nasc e uma outra coluna que informe a idade do usuário em anos. 
--Use o comando datediff() e nomeie a coluna para "idade".
...
--Escreva um comando select que retorne as seguintes colunas: nome, data_nasc e uma outra coluna que informe a idade do usuário em anos ordenados do 
--maior para o menor. Use o comando datediff() e nomeie a coluna para "idade". 
