...
-- Com base nos conteúdos de JOIN vistos em sala, faça o que se pede utilizando o Script SQL do banco de dados Mercado em anexo: 
...
-- valor total da compra que eles já realizaram.
SELECT 
